    ...
    <div className="flex flex-col h-full space-y-6 max-w-[1400px] mx-auto animate-in fade-in duration-500 w-full">
      <div className="flex flex-col sm:flex-row gap-4 justify-between items-end">
        <div className="w-full sm:w-auto">
          ...
          <p className="text-sm text-text-muted">Encontre, analise e aborde novos clientes em potencial.</p>
        </div>
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <Button variant="outline" className="h-9">Filtros Avançados</Button>
      ...
      <DashboardSurface className="flex-1 flex flex-col min-h-[500px]">
        ...
        <div className="p-4 border-b border-border-default bg-surface flex flex-col sm:flex-row gap-4 justify-between">
          ...
          <div className="flex items-center gap-2">
            <span className="text-xs font-medium text-text-muted uppercase tracking-wider mr-2">Status</span>
            <div className="flex items-center bg-surface-elevated p-1 rounded-lg border border-border-subtle">
              <button className="px-3 py-1 text-xs font-medium bg-surface rounded shadow-sm border border-border-default text-text-primary">Todos</button>
              <button className="px-3 py-1 text-xs font-medium text-text-secondary hover:text-text-primary">Novos</button>
              <button className="px-3 py-1 text-xs font-medium text-text-secondary hover:text-text-primary">Contatados</button>
            </div>
          </div>
        </div>
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className={cn(
                          ...
                          isSelected ? "bg-primary text-white" : "bg-surface-elevated border border-border-default text-text-secondary group-hover:border-primary/30 group-hover:text-primary"
                        )}>
                    ...
                    <td className="px-6 py-4 text-right whitespace-nowrap">
                      <div className="flex items-center justify-end gap-1.5">
                        ...
                        {lead.hasWhatsapp && (
                          <div className="w-6 h-6 rounded flex items-center justify-center bg-[#25D366]/10 text-[#25D366] border border-[#25D366]/20">
