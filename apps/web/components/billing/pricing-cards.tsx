    ...
    <div className="flex flex-col gap-12 w-full max-w-6xl mx-auto py-8">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col p-6 rounded-2xl border bg-card text-card-foreground shadow-sm">
          ...
          <ul className="flex flex-col gap-3 flex-1 mb-8 text-sm">
            <li className="flex items-center gap-2">
              <Check className="h-4 w-4 text-emerald-500" /> 1 busca por dia
            </li>
            <li className="flex items-center gap-2">
              <Check className="h-4 w-4 text-emerald-500" /> Até 5 leads por
              busca
            </li>
            <li className="flex items-center gap-2">
              <Check className="h-4 w-4 text-emerald-500" /> Instagram
              disponível
            </li>
          </ul>
          <button
        ...
        <div className="flex flex-col p-6 rounded-2xl border-2 border-primary bg-card text-card-foreground shadow-md relative">
          ...
          <ul className="flex flex-col gap-3 flex-1 mb-8 text-sm">
            <li className="flex items-center gap-2">
              <Check className="h-4 w-4 text-emerald-500" /> 10 buscas por dia
            </li>
            <li className="flex items-center gap-2">
              <Check className="h-4 w-4 text-emerald-500" /> Dezenas de
              oportunidades por busca
            </li>
            <li className="flex items-center gap-2">
              <Check className="h-4 w-4 text-emerald-500" /> Todos os resultados
              encontrados
            </li>
            <li className="flex items-center gap-2">
              <Check className="h-4 w-4 text-emerald-500" /> WhatsApp, Telefone
              e Site
            </li>
            <li className="flex items-center gap-2">
              <Check className="h-4 w-4 text-emerald-500" /> Filtro inteligente
              por serviço
            </li>
          </ul>
          <button
        ...
        <div className="flex flex-col p-6 rounded-2xl border bg-card text-card-foreground shadow-sm">
          ...
          <ul className="flex flex-col gap-3 flex-1 mb-8 text-sm">
            <li className="flex items-center gap-2">
              <Check className="h-4 w-4 text-emerald-500" /> Buscas ilimitadas
            </li>
            <li className="flex items-center gap-2">
              <Check className="h-4 w-4 text-emerald-500" /> Resultados
              ilimitados
            </li>
            <li className="flex items-center gap-2">
              <Check className="h-4 w-4 text-emerald-500" /> Todos os contatos
              disponíveis
            </li>
            <li className="flex items-center gap-2">
              <Check className="h-4 w-4 text-emerald-500" /> Exportação para
              Excel
            </li>
            <li className="flex items-center gap-2">
              <Check className="h-4 w-4 text-emerald-500" /> Acesso prioritário
              a recursos
            </li>
          </ul>
          <button
      ...
      <div className="mt-8 border-t pt-12">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            Precisa de mais buscas? Adicione créditos sem mudar de plano. (1
            crédito = 1 busca extra)
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {CREDIT_PACKAGES.map((pkg) => (
            <div
              key={pkg.id}
              className={`flex flex-col p-5 rounded-xl border relative ${pkg.isPopular ? "border-primary shadow-sm bg-primary/5" : "bg-card"}`}
            >
              {pkg.label && (
