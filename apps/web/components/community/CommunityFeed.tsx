      ...
      : [
          {
            ...
            isVerified: true,
            content:
              "Fechamento usando o novo template de cold email focado em dores de clínicas. 3 dias desde o primeiro contato até o contrato assinado.",
          ...
          },
          {
            ...
            isVerified: false,
            content:
              "Dica: sempre filtre por 'Sem site' ao prospectar restaurantes locais. A taxa de resposta quando você oferece uma solução rápida de cardápio digital aumenta em 40%.",
            ...
            <div className="p-5">
              ...
              <div className="flex items-center gap-4 pt-4 border-t border-border-subtle">
                ...
                <Button
                  ...
                  className="text-text-muted hover:text-text-primary hover:bg-surface-elevated h-8 text-xs font-medium"
                >
                  <MessageSquarePlus className="w-3.5 h-3.5 mr-1.5" /> Discutir
                  ({post.commentCount})
                </Button>
              </div>
            </div>
