...
export function ForgotPasswordForm() {
    ...
    return (
      <div className="w-full text-center">
        ...
        <p className="text-slate-400 mb-8">
          Se houver uma conta associada a esse email, você receberá instruções para redefinir sua senha.
        </p>
  ...
  return (
    <div className="w-full">
      <div className="mb-8">
        <h2 className="text-2xl font-semibold text-white tracking-tight">Recuperar senha</h2>
      ...
      <form action={formAction} className="space-y-6">
        <div className="space-y-2">
          <Label htmlFor="email" className={state?.error ? "text-red-400" : ""}>Email</Label>
          <Input
            id="email"
            name="email"
            type="email"
            ...
            className={`bg-slate-900/50 border-slate-800 focus-visible:ring-purple-500/50 ${
              state?.error ? "border-red-500/50 focus-visible:ring-red-500/20" : ""
            }`}
          />
        </div>
