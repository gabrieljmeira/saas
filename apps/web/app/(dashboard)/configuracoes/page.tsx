...
import { User, KeyRound, Building, AtSign, Mail, ShieldCheck } from "lucide-react";
  ...
  return (
    <div className="flex-1 p-6 md:p-8 max-w-[900px] mx-auto w-full flex flex-col gap-8 animate-in fade-in duration-500">
      <div className="border-b border-border-default pb-6">
        <h1 className="text-2xl font-semibold text-text-primary tracking-tight mb-1">Configurações</h1>
        <p className="text-sm text-text-muted">Gerencie as preferências da sua conta e do seu perfil público.</p>
      </div>
      ...
      <div className="space-y-8">
        ...
        <section>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-sm font-semibold text-text-primary uppercase tracking-wider">Perfil Profissional</h3>
          </div>
        ...
        <section>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-sm font-semibold text-text-primary uppercase tracking-wider">Identidade na Comunidade</h3>
          </div>
          <DashboardSurface className="p-6">
        ...
        <section>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-sm font-semibold text-text-primary uppercase tracking-wider">Segurança e Acesso</h3>
          </div>
          <DashboardSurface className="p-6">
            <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center justify-between">
              ...
              <Button variant="outline" className="h-10 mt-6 sm:mt-0 shadow-sm whitespace-nowrap">
