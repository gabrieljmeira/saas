        ...
        <section className="relative pt-24 pb-20 md:pt-32 md:pb-28 overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 flex flex-col items-center text-center">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-[4.5rem] font-bold tracking-tight max-w-4xl mb-6 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100 text-white leading-tight">
              Encontre empresas que precisam do seu serviço.
              <br />
              <span className="block mt-2">
                Aborde pelo{" "}
                <span className="inline-flex items-center text-emerald-500 gap-2">
                  WhatsApp{" "}
                  <MessageSquare className="w-8 h-8 md:w-12 md:h-12 hidden sm:inline" />
                </span>{" "}
            ...
            <p className="text-lg md:text-xl text-slate-400 max-w-2xl mb-10 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200 leading-relaxed">
              Busque empresas por nicho e região, identifique oportunidades com
              IA e receba uma abordagem personalizada pronta para iniciar a
              conversa.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 animate-in fade-in slide-in-from-bottom-10 duration-700 delay-300 mb-20 w-full sm:w-auto">
              <Link href="/login" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  className="w-full sm:w-auto rounded-full px-8 h-12 text-base font-medium bg-purple-600 hover:bg-purple-700 text-white border-0 shadow-xl shadow-purple-600/25"
                >
                  Começar grátis
                </Button>
              </Link>
              <Link href="#como-funciona" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  variant="outline"
                  className="w-full sm:w-auto rounded-full px-8 h-12 text-base font-medium bg-slate-900/50 border-slate-800 text-slate-200 hover:bg-slate-800 hover:text-white backdrop-blur-sm"
                >
                  Ver como funciona
                </Button>
              </Link>
            ...
            <div
              id="produto"
              className="w-full max-w-4xl mx-auto rounded-2xl border border-slate-800/80 bg-slate-900/60 backdrop-blur-md p-5 shadow-2xl animate-in fade-in slide-in-from-bottom-12 duration-700 delay-500"
            >
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="bg-slate-950/80 border border-slate-800 rounded-xl p-5 text-left flex flex-col sm:flex-row sm:items-center justify-between gap-6 relative overflow-hidden group hover:border-purple-500/30 transition-colors">
                  ...
                  <div className="flex-1 pl-2">
                    ...
                    <div className="flex flex-wrap gap-x-5 gap-y-2 text-sm text-slate-400 mb-5">
                      <span className="flex items-center gap-1.5">
                        <X className="w-3.5 h-3.5 text-rose-500" /> Sem site
                        próprio
                      </span>
                      <span className="flex items-center gap-1.5">
                      ...
                      <span className="flex items-center gap-1.5">
                        <Check className="w-3.5 h-3.5 text-emerald-500" /> 382
                        avaliações
                      </span>
                    </div>
                    ...
                    <div className="flex items-start gap-3 bg-purple-900/20 border border-purple-500/20 rounded-lg p-3.5">
                      ...
                      <p className="text-sm text-purple-200/90 leading-relaxed">
                        <strong className="text-purple-300 font-medium mr-1">
                          Insight IA:
                        </strong>
                        Boa oportunidade para oferecer uma landing page focada
                        em pedidos e melhorar a presença digital.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-2.5 shrink-0 w-full sm:w-40">
                    <Button
                      variant="outline"
                      className="w-full bg-slate-900 border-slate-700 hover:bg-slate-800 text-slate-200"
                    >
                      Ver análise
                    </Button>
        ...
        <section className="py-16 border-y border-slate-800/50 bg-slate-900/20">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap justify-center items-center gap-4 text-sm">
              <span className="px-4 py-2 rounded-full bg-slate-900 border border-slate-800 text-slate-300 font-medium">
